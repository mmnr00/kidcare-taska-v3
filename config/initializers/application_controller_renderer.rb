...
$ph_sel19 = {1  => { 1  => "New Year's Day" },
2  => { 1  => "Thaipusam",
         2  => "Thaipusam Holiday",
         17 => "Chinese New Year",
         18 => "Chinese New Year Holiday" },
3  => { 7  => "Nuzul Al-Quran",
         21 => "Hari Raya Aidilfitri",
         22 => "Hari Raya Aidilfitri Holiday",
         23 => "Hari Raya Aidilfitri Holiday" },
5  => { 1  => "Labour Day",
         27 => "Hari Raya Haji",
         31 => "Wesak Day" },
6  => { 1  => "Agong's Birthday",
         17 => "Awal Muharram" },
8  => { 25 => "Prophet Muhammad's Birthday",
         31 => "Merdeka Day" },
9  => { 16 => "Malaysia Day" },
11 => { 8  => "Deepavali",
         9  => "Deepavali Holiday" },
