Rails.application.routes.draw do
  ...
  #~ADMINS
  post 'addtskcls_adm', to: 'admins#addtskcls_adm'
  ...
  #~TASKAS
  get 'adm_crt_bill', to: 'taskas#adm_crt_bill'
  get 'update_contact', to: 'taskas#update_email'
  ...
  get '/taska/:id/xlstch', to: 'taskas#xlstch', as: 'xlstch'
  get '/taska/:id/temptchxls', to: 'taskas#temptchxls', as: 'temptchxls'
  post '/taska/:id/upldtch', to: 'taskas#upldtch', as: 'upldtch'
  ...
  get '/billview', to: 'kids#billvw', as: 'billview'
  ...
  #~payments
  get '/updmthbill', to: 'payments#updmthbill'
  get '/whatsapp_history', to: 'payments#whatsapp_history'
